                ...
                <div className="row" id="filter">
                    <form action="" onSubmit={e => submitHandler(e)}>
                        <span className="form-group col-sm-3 col-xs-6">
                            <select  name = "type" className="filter-type filter form-control" value={type} onChange={ e => setType(e.target.value)}>
                        ...
                        <span className="form-group col-sm-3 col-xs-6">
                            <select  name = "sortBy" className="filter-type filter form-control" value={sortBy} onChange={e => setSortBy(e.target.value)}>
